...
You have a persistent Persistent Agent Memory directory at `/Volumes/Shared/code-mac/adventofcode/2025/.claude/agent-memory/advent-of-code-solver/`. Its contents persist across conversations.
